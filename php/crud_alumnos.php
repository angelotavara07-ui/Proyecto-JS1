...
NOMBRE_APODERADO, CELULAR_APODERADO, USERNAME, ESTADO, PASSWORD_HASH)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
$stmt = $pdo->prepare($sql);
$stmt->execute([
$_POST['dni'], $_POST['nombres'], $_POST['apellidos'],
$_POST['fecha_nac'],
$_POST['edad'], $_POST['genero'], $_POST['direccion'],
$_POST['celular'],
$_POST['correo'], $_POST['apoderado'],
$_POST['cel_apoderado'], $_POST['username'], $_POST['estado'], $hash
]);
...
$_POST['username'], $hash, $_POST['estado'], $_POST['id_alumno']];
